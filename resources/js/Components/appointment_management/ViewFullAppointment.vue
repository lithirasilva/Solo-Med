    ...
    <div class="p-8 bg-white rounded-lg shadow-lg max-w-3xl mx-auto">
        ...
        <div v-if="appointment">
            ...
            <div class="mb-8 p-6 border border-gray-200 rounded-lg shadow-sm">
                ...
                <p class="text-gray-700"><strong>Name:</strong> {{ appointment.patient_name }}</p>
                <p class="text-gray-700"><strong>Age:</strong> {{ appointment.patient_age }}</p>
                <p class="text-gray-700"><strong>Email:</strong> {{ appointment.patient_email }}</p>
                <p class="text-gray-700"><strong>Phone:</strong> {{ appointment.patient_phone }}</p>
                <button
            ...
            <div class="mb-8 p-6 border border-gray-200 rounded-lg shadow-sm">
                ...
                <p class="text-gray-700"><strong>Name:</strong> {{ appointment.doctor_name }}</p>
            </div>
